...
{
  /* battery_value */
  CUSTOM_STM_BVAL_READ_EVT,
  CUSTOM_STM_BVAL_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_BVAL_NOTIFY_DISABLED_EVT,
  /* eeg_value */
  CUSTOM_STM_VAL_READ_EVT,
  CUSTOM_STM_VAL_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_VAL_NOTIFY_DISABLED_EVT,
